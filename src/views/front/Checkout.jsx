...
import { currency } from "../../utilty/filiter";
...
const Checkout = () => {
    ...
    const onSubmit = async (formData) => {
        ...
        try {
            ...
            const res2 = await axios.post(`${API_BASE}/api/${API_PATH}/order`, { data })
    ...
    const handleView = async (id) => {
        ...
        try {
            const response3 = await axios.get(`${API_BASE}/api/${API_PATH}/product/${id}`)
            setProduct(response3.data.product)
                                    ...
                                    <td>
                                        <div className="input-group input-group-sm mb-3">
                                            <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"
                                                defaultValue={cartItem.qty} min={1}
